"""
Django settings for snippetcodes project.
...
SECRET_KEY = 'q#$5&^fg-+bksdco9tn&-f7pi^ge_vdd9#88ipy$rjy4+7gvs6'
...
ROOT_URLCONF = 'snippetcodes.urls'
...
WSGI_APPLICATION = 'snippetcodes.wsgi.application'
